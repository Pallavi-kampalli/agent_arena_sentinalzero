    ...
    with httpx.Client(base_url=base_url, timeout=30.0) as http:
        ...
        teams_config = [
            ...
            },
            {
                ...
                "strategy": "Starter-Kit Participant Agent (Partial Edge Case Coverage)",
                "solver": starter_kit_solve,
            },
            {
                "key": "gamma",
        ...
        # 8b. Revert settings back to canonical production defaults (200 tasks, 180s budget)
        http.put(
            "/admin/settings/time_budget_per_task_seconds",
            json={"value": 180},
            headers=admin_headers,
        ...
        assert final_settings["hidden_task_count"] == 200, f"Expected 200, got {final_settings['hidden_task_count']}"
